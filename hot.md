...
- **Jigsy's Ordering Demo** — live isolated demo with 52 priced items,
  ...
  staff access, notifications, and printer verification.
- **COMMS LINK** — ⏸️ PARKED 2026-07-20. [[COMMS LINK]].
- **Apex Scheduler** — RLS pushed; branch `feat/apex-plan-2026-07-21` not merged/audited. Human: apply RLS on Supabase.
- **New Horizon** — 117/117; fork reconciliation COMPLETE.
- **DELETED:** wisense-os, my_ai, local-agent-work-center, command_center.

## Active Threads
- **LAUNCH:** Apex RLS apply → Gate C. COMMS LINK parked.
- **⚡ PLAN:** [[business/Plan of Attack — Build While Mac-Blocked 2026-07-20]]
