...
✅ **Fee economics fixed 2026-07-30: direct charges.** A $34.94 order now shows one entry on the platform ledger — `application_fee +52, fee 0` — no charge, no transfer, no processing fee. The venue bears Stripe's cost and WiSense keeps its full 1.5%. Was −67¢ on a $26.47 order hours earlier. See [[wisense/projects/APEX_PLATFORM_FEE_ECONOMICS_2026-07-30]].
