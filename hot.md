...
💵 **Fee model settled 2026-07-30: direct charges + guest-paid service fee.** On a $32.96 order the guest pays $35.46, the venue nets $33.61, WiSense earns 52¢ — versus **losing 67¢** that morning. The venue is 50¢ better off than where this started; the customer covers the 1.5%, which is what Jigsy was originally pitched. **Pitch line: an online order costs the venue card processing and nothing else — same as a card tapped at their counter.** Pay-at-pickup is charged food and tax only. Two rules keep it a service fee rather than a card surcharge: never call it a card/processing fee, never vary it by payment method. See [[wisense/projects/APEX_PLATFORM_FEE_ECONOMICS_2026-07-30]].
