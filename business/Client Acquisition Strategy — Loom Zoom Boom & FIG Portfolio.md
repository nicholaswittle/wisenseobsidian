---
title: Client Acquisition Strategy — Loom Zoom Boom & FIG Portfolio Framework
tags: [business, sales, outreach, loom-zoom-boom, fig-portfolio, client-acquisition, agency-strategy]
date: 2026-07-26
...
```mermaid
flowchart TD
    A["1. Identify Target Business (Local Audit)"] --> B["2. Antigravity Builds Live Vercel Demo Prototype"]
    B --> C["3. Record 90-Sec Loom Video (Broken Site vs. Live Demo)"]
    C --> D["4. Send Frictionless Outreach (Email / DM / Cold Call)"]
    D --> E["💰 Close $0 Upfront + $0.99/order OR $79 - $149/mo Care Plan"]
```
