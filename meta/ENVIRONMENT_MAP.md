...
|---|---|---|---|---|
| **Ollama** | `127.0.0.1` | `11434` | `GET /api/tags` | Local / Ollama-cloud LLM inference ([[meta/Working Stack — Claude CLI and Ollama]]) |
...
Related: [[00_AI_AGENT_MANIFEST]], [[Working Stack — Claude CLI and Ollama]], [[company/WiSense Governance — Rules and Protocols]]
