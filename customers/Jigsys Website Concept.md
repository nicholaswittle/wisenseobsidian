...
(Enola, PA) — the same business that is the [[customers/Jigsys Brewpub|Apex pilot
...
See [[Jigsys Ordering Demo — Build Record 2026-07-23]].
...
model: [[Restaurant Online Ordering — Pitch Research 2026-07-23]].
...
relationship). Model rationale: [[Web Redesign — Recurring Model Proposal 2026-07-23]].

Related: [[customers/Jigsys Brewpub]], [[Apex Scheduler]], [[Jigsys Website & Direct Ordering Master Plan]], [[WiSense Operational Partner Plan — Jigsy's]], [[NOW]], [[index]]
